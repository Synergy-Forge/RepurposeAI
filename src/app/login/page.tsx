      ...
      <div className="flex justify-center items-center min-h-screen py-10 px-5">
        <div className="bg-gray-900/85 backdrop-blur-md border border-white/10 rounded-2xl p-10 w-full max-w-md text-center shadow-2xl">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full py-4 border-none rounded-lg text-base font-bold cursor-pointer transition-all duration-300 text-center flex justify-center items-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white mb-3 hover:opacity-90 hover:shadow-lg hover:shadow-purple-500/50"
            >
              {t('auth.login')}
            </button>
            ...
            <button
              ...
              className="w-full py-3 border border-purple-500 rounded-lg text-base font-bold cursor-pointer transition-all duration-300 text-center flex justify-center items-center gap-2 bg-transparent text-purple-500 hover:bg-purple-500 hover:text-white mb-5"
            >
